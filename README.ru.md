...
# Четыре продукта. Два месяца. Один человек.

Около года учёбы, за который я не выпустил ничего. Потом, к сентябрю 2026-го: настольный журнал
...
- **Мне нужен объём.** Четыре продукта за два месяца — тот темп, в котором мне нравится
