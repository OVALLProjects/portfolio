...
итог в R, профит-фактор со средним плюсом и средним минусом под ним, доля зелёных дней и
...
таблицы, из формы или отовсюду — и переставить, задав номер порядка. И можно завести свою: текст,
